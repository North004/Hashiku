...
pub fn get_patterns<'a>() -> Vec<Pattern<'a>> {
    vec![
     Pattern { regex: regex!(r##"(?i)^[a-f0-9]{4}$"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)^[a-f0-9]{8}$"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)^[a-f0-9]{16}$"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)(?:\$haval\$)?[a-f0-9]{32,64}$"##), modes: vec![
          HashInfo{ name: "Haval-128", john: Some("haval-128-4") ,hashcat: None ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)(?:\$ripemd\$)?[a-f0-9]{32,40}$"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)(?:\$dynamic_39\$)?[a-f0-9]{32}\$[a-z0-9]{1,32}\$?[a-z0-9]{1,500}"##), modes: vec![
          HashInfo{ name: "net-md5", john: Some("dynamic_39") ,hashcat: None ,variation: true ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^[a-f0-9]{32}:[a-z0-9]+$"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)^\$1\$[a-z0-9\/.]{0,8}\$[a-z0-9\/.]{22}(:.*)?$"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)^0x[a-f0-9]{32}$"##), modes: vec![
          HashInfo{ name: "Lineage II C4", john: None ,hashcat: None ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$H\$[a-z0-9\/.]{31}$"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)^\$P\$[a-z0-9\/.]{31}$"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)^[a-f0-9]{32}:[a-z0-9]{2}$"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)^\$apr1\$[a-z0-9\/.]{0,8}\$[a-z0-9\/.]{22}$"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)^(\$md5,rounds=[0-9]+\$|\$md5\$rounds=[0-9]+\$|\$md5\$)[a-z0-9\/.]{0,16}(\$|\$\$)[a-z0-9\/.]{22}$"##), modes: vec![
          HashInfo{ name: "Sun MD5 Crypt", john: Some("sunmd5") ,hashcat: Some("3300") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^[a-f0-9]{56}$"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)^(\$2[abxy]?|\$2)\$[0-9]{2}\$[a-z0-9\/.]{53}$"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)^\$y\$[.\/A-Za-z0-9]+\$[.\/a-zA-Z0-9]+\$[.\/A-Za-z0-9]{43}$"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)^\{SSHA512}[a-z0-9\/+]{96}$"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)^\{ssha512}[0-9]{2}\$[a-z0-9\/.]{16,48}\$[a-z0-9\/.]{86}$"##), modes: vec![
          HashInfo{ name: "AIX(ssha512)", john: Some("aix-ssha512") ,hashcat: Some("6500") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^[a-f0-9]{128}(:.+)?$"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)^[a-f0-9]{136}$"##), modes: vec![
          HashInfo{ name: "OSX v10.7", john: Some("xsha512") ,hashcat: Some("1722") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^0x0200[a-f0-9]{136}$"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)^\$ml\$[0-9]+\$[a-f0-9]{64}\$[a-f0-9]{128}$"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)^\$oldoffice\$[34]\*[a-f0-9]{32}\*[a-f0-9]{32}\*[a-f0-9]{40}$"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)^\$oldoffice\$[34]\*[a-f0-9]{32}\*[a-f0-9]{32}\*[a-f0-9]{40}:[a-f0-9]{10}"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)\$pdf\$1\*[2|3]\*[0-9]{2}\*[-0-9]{1,6}\*[0-9]\*[0-9]{2}\*[a-f0-9]{32}\*[0-9]{2}\*[a-f0-9]{64}\*[0-9]{2}\*[a-f0-9]{64}:[a-f0-9]{10}"##), modes: vec![
          HashInfo{ name: "PDF 1.1 - 1.3 (Acrobat 2 - 4), collider #2", john: None ,hashcat: Some("10420") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$pdf\$[24]\*[34]\*128\*[0-9-]{1,5}\*1\*(16|32)\*[a-f0-9]{32,64}\*32\*[a-f0-9]{64}\*(8|16|32)\*[a-f0-9]{16,64}$"##), modes: vec![
          HashInfo{ name: "PDF 1.4 - 1.6 (Acrobat 5 - 8)", john: Some("pdf") ,hashcat: Some("10500") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)\$pdf\$5\*[5|6]\*[0-9]{3}\*[-0-9]{1,6}\*[0-9]\*[0-9]{1,4}\*[a-f0-9]{0,1024}\*[0-9]{1,4}\*[a-f0-9]{0,1024}\*[0-9]{1,4}\*[a-f0-9]{0,1024}\*[0-9]{1,4}\*[a-f0-9]{0,1024}\*[0-9]{1,4}\*[a-f0-9]{0,1024}"##), modes: vec![
          HashInfo{ name: "PDF 1.7 Level 3 (Acrobat 9)", john: Some("pdf") ,hashcat: Some("10600") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)\$pdf\$5\*[5|6]\*[0-9]{3}\*[-0-9]{1,6}\*[0-9]\*[0-9]{1,4}\*[a-f0-9]{0,1024}\*[0-9]{1,4}\*[a-f0-9]{0,1024}\*[0-9]{1,4}\*[a-f0-9]{0,1024}"##), modes: vec![
          HashInfo{ name: "PDF 1.7 Level 8 (Acrobat 10 - 11)", john: Some("pdf") ,hashcat: Some("10700") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$krb5asrep\$23\$[^:]+:[a-f0-9]{32,32}\$[a-f0-9]{64,40960}$"##), modes: vec![
          HashInfo{ name: "Kerberos 5 AS-REP etype 23", john: Some("krb5pa-sha1") ,hashcat: Some("18200") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$krb5tgs\$17\$[^$]{1,512}\$[^$]{1,512}\$[^$]{1,4}?\$?[a-f0-9]{1,32}\$[a-f0-9]{64,40960}$"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)^\$krb5tgs\$18\$[^$]{1,512}\$[^$]{1,512}\$[^$]{1,4}?\$?[a-f0-9]{1,32}\$[a-f0-9]{64,40960}"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)\$monero\$(0)\*[a-f0-9]{32,3196}"##), modes: vec![
          HashInfo{ name: "Monero", john: Some("monero") ,hashcat: None ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$electrum\$[1-3]\*[a-f0-9]{32,32}\*[a-f0-9]{32,32}$"##), modes: vec![
          HashInfo{ name: "Electrum Wallet (Salt-Type 1-3)", john: Some("electrum") ,hashcat: Some("16600") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$electrum\$4\*[a-f0-9]{1,66}\*[a-f0-9]{128,32768}\*[a-f0-9]{64,64}$"##), modes: vec![
          HashInfo{ name: "Electrum Wallet (Salt-Type 4)", john: Some("electrum") ,hashcat: Some("21700") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$electrum\$5\*[a-f0-9]{66,66}\*[a-f0-9]{2048,2048}\*[a-f0-9]{64,64}$"##), modes: vec![
          HashInfo{ name: "Electrum Wallet (Salt-Type 5)", john: Some("electrum") ,hashcat: Some("21800") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)\$ab\$[0-9]{1}\*[0-9]{1}\*[0-9]{1,6}\*[a-f0-9]{128}\*[a-f0-9]{128}\*[a-f0-9]{32}\*[a-f0-9]{192}"##), modes: vec![
          HashInfo{ name: "Android Backup", john: Some("androidbackup") ,hashcat: Some("18900") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)\$zip2\$\*[0-9]{1}\*[0-9]{1}\*[0-9]{1}\*[a-f0-9]{16,32}\*[a-f0-9]{1,6}\*[a-f0-9]{1,6}\*[a-f0-9]+\*[a-f0-9]{20}\*\$\/zip2\$"##), modes: vec![
          HashInfo{ name: "WinZip", john: Some("zip") ,hashcat: Some("13600") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)\$itunes_backup\$\*[0-9]{1,2}\*[a-f0-9]{80}\*[0-9]{1,6}\*[a-f0-9]{40}\*[0-9]{0,10}\*[a-f0-9]{0,40}"##), modes: vec![
     ...
     Pattern { regex: regex!(r##"(?i)\$7z\$[0-9]\$[0-9]{1,2}\$[0-9]{1}\$[^$]{0,64}\$[0-9]{1,2}\$[a-f0-9]{32}\$[0-9]{1,10}\$[0-9]{1,6}\$[0-9]{1,6}\$[a-f0-9]{2,}"##), modes: vec![
          HashInfo{ name: "7-zip", john: Some("7z") ,hashcat: Some("11600") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)\$zip3\$\*[0-9]\*[0-9]\*256\*[0-9]\*[a-f0-9]{0,32}\*[a-f0-9]{288}\*[0-9]\*[0-9]\*[0-9]\*[^\s]{0,64}"##), modes: vec![
          HashInfo{ name: "SecureZIP AES-256", john: Some("securezip") ,hashcat: Some("23003") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)\$zip3\$\*[0-9]\*[0-9]\*192\*[0-9]\*[a-f0-9]{0,32}\*[a-f0-9]{288}\*[0-9]\*[0-9]\*[0-9]\*[^\s]{0,64}"##), modes: vec![
          HashInfo{ name: "SecureZIP AES-192", john: Some("securezip") ,hashcat: Some("23002") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)\$zip3\$\*[0-9]\*[0-9]\*128\*[0-9]\*[a-f0-9]{0,32}\*[a-f0-9]{288}\*[0-9]\*[0-9]\*[0-9]\*[^\s]{0,64}"##), modes: vec![
          HashInfo{ name: "SecureZIP AES-128", john: Some("securezip") ,hashcat: Some("23001") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$pkzip2?\$(1)\*[0-9]{1}\*[0-9]{1}\*[0-9a-f]{1,3}\*[0-9a-f]{1,8}\*[0-9a-f]{1,4}\*[0-9a-f]{1,8}\*[0-9a-f]{1,8}\*[0-9a-f]{1,8}\*(8)\*[0-9a-f]{1,8}(\*[0-9a-f]{1,8})?\*[0-9a-f]{1,8}\*[a-f0-9]+\*\$\/pkzip2?\$$"##), modes: vec![
          HashInfo{ name: "PKZIP (Compressed)", john: Some("pkzip") ,hashcat: Some("17200") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$pkzip2?\$(1)\*[0-9]{1}\*[0-9]{1}\*[0-9a-f]{1,8}\*[0-9a-f]{1,8}\*[0-9a-f]{1,8}\*[0-9a-f]{1,8}\*[0-9a-f]{1,8}\*[0-9a-f]{1,8}\*(0)\*[0-9a-f]{1,8}(\*[0-9a-f]{1,8})?\*[0-9a-f]{1,8}\*[a-f0-9]+\*\$\/pkzip2?\$$"##), modes: vec![
          HashInfo{ name: "PKZIP (Uncompressed)", john: Some("pkzip") ,hashcat: Some("17210") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$pkzip2?\$([2-8])\*[0-9]{1}(\*[0-9]{1}\*[0-9a-f]{1,3}\*([^0*][0-9a-f]{0,2})\*[0-9a-f]{1,8}(\*[0-9a-f]{1,8})?\*[0-9a-f]{1,8}\*[0-9a-f]+)+\*(8)\*[0-9a-f]{1,8}(\*[0-9a-f]{1,8})?\*[0-9a-f]{1,8}\*[a-f0-9]+\*\$\/pkzip2?\$$"##), modes: vec![
          HashInfo{ name: "PKZIP (Compressed Multi-File)", john: Some("pkzip") ,hashcat: Some("17220") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$pkzip2?\$([2-8])\*[0-9]{1}(\*[0-9]{1}\*[0-9a-f]{1,8}\*([0-9a-f]{1,8})\*[0-9a-f]{1,8}(\*[0-9a-f]{1,8})?\*[0-9a-f]{1,8}\*[0-9a-f]+)+\*([08])\*[0-9a-f]{1,8}(\*[0-9a-f]{1,8})?\*[0-9a-f]{1,8}\*[a-f0-9]+\*\$\/pkzip2?\$$"##), modes: vec![
          HashInfo{ name: "PKZIP (Mixed Multi-File)", john: Some("pkzip") ,hashcat: Some("17225") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$pkzip2?\$([2-8])\*[0-9]{1}(\*[0-9]{1}\*[0-9a-f]{1,3}\*[0-9a-f]{1,8}\*[0-9a-f]{1,8}(\*[0-9a-f]{1,8})?\*[0-9a-f]{1,8}\*[0-9a-f]+)+\*\$\/pkzip2?\$$"##), modes: vec![
          HashInfo{ name: "PKZIP (Mixed Multi-File Checksum-Only)", john: Some("pkzip") ,hashcat: Some("17230") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$argon2i\$v=19\$m=[0-9]{1,6},t=[0-9]{1,2},p=[0-9]{1,2}\$[^$]+\$[^\s]{6,134}$"##), modes: vec![
          HashInfo{ name: "Argon2i", john: Some("argon2") ,hashcat: None ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$argon2id\$v=19\$m=[0-9]{1,6},t=[0-9]{1,2},p=[0-9]{1,2}\$[^$]+\$[^\s]{6,134}$"##), modes: vec![
          HashInfo{ name: "Argon2id", john: None ,hashcat: None ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$argon2d\$v=19\$m=[0-9]{1,6},t=[0-9]{1,2},p=[0-9]{1,2}\$[^$]+\$[^\s]{6,134}$"##), modes: vec![
          HashInfo{ name: "Argon2d", john: Some("argon2") ,hashcat: None ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)\$bitlocker\$[0-9]\$[0-9]{2}\$[a-f0-9]{32}\$[a-f0-9]{7}\$[a-f0-9]{2}\$[a-f0-9]{24}\$[a-f0-9]{2}\$[a-f0-9]{120}"##), modes: vec![
          HashInfo{ name: "BitLocker", john: Some("bitlocker") ,hashcat: Some("22100") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)\$racf\$\*.{1,}\*[A-F0-9]{16}"##), modes: vec![
          HashInfo{ name: "RACF", john: None ,hashcat: Some("8500") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$sshng\$4\$16\$[0-9]{32}\$1232\$[a-f0-9]{2464}$"##), modes: vec![
          HashInfo{ name: "RSA/DSA/EC/OpenSSH Private Keys ($4$)", john: None ,hashcat: Some("22941") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$RAR3\$\*(1)\*[0-9a-f]{1,16}\*[0-9a-f]{1,8}\*[0-9a-f]{1,16}\*[0-9a-f]{1,16}\*[01]\*([0-9a-f]+|[^*]{1,64}\*[0-9a-f]{1,16})\*30$"##), modes: vec![
          HashInfo{ name: "RAR3-p (Uncompressed)", john: Some("rar") ,hashcat: Some("23700") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$RAR3\$\*(1)\*[0-9a-f]{1,16}\*[0-9a-f]{1,8}\*[0-9a-f]{1,16}\*[0-9a-f]{1,16}\*[01]\*([0-9a-f]+|[^*]{1,64}\*[0-9a-f]{1,16})\*(31|32|33|34|35)$"##), modes: vec![
          HashInfo{ name: "RAR3-p (Compressed)", john: Some("rar") ,hashcat: Some("23800") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$RAR3\$\*0\*[0-9a-f]{1,16}\*[0-9a-f]+$"##), modes: vec![
          HashInfo{ name: "RAR3-hp", john: Some("rar") ,hashcat: Some("12500") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$rar5\$[0-9a-f]{1,2}\$[0-9a-f]{1,32}\$[0-9a-f]{1,2}\$[0-9a-f]{1,32}\$[0-9a-f]{1,2}\$[0-9a-f]{1,16}$"##), modes: vec![
          HashInfo{ name: "RAR5", john: Some("rar5") ,hashcat: Some("13000") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$keepass\$\*1\*\d+\*\d\*[0-9a-f]{32}\*[0-9a-f]{64}\*[0-9a-f]{32}\*[0-9a-f]{64}\*\d\*[^*]*(\*[0-9a-f]+)?$"##), modes: vec![
          HashInfo{ name: "KeePass 1 AES (without keyfile)", john: Some("KeePass") ,hashcat: Some("13400") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$keepass\$\*1\*\d+\*\d\*[0-9a-f]{32}\*[0-9a-f]{64}\*[0-9a-f]{32}\*[0-9a-f]{64}\*\d\*[^*]*(\*[0-9a-f]+)?\*\d+\*\d+\*[0-9a-f]{64}$"##), modes: vec![
          HashInfo{ name: "KeePass 1 TwoFish (with keyfile)", john: Some("KeePass") ,hashcat: Some("13400") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$keepass\$\*2\*\d+\*\d+\*[0-9a-f]+\*[0-9a-f]+\*[0-9a-f]+\*[0-9a-f]+\*[0-9a-f]+$"##), modes: vec![
          HashInfo{ name: "KeePass 2 AES (without keyfile)", john: Some("KeePass") ,hashcat: Some("13400") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$keepass\$\*2\*\d+\*\d+\*[0-9a-f]+\*[0-9a-f]+\*[0-9a-f]+\*[0-9a-f]+\*[0-9a-f]+\*\d+\*\d+\*[0-9a-f]+$"##), modes: vec![
          HashInfo{ name: "KeePass 2 AES (with keyfile)", john: Some("KeePass") ,hashcat: Some("13400") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^\$odf\$\*1\*1\*100000\*32\*[a-f0-9]{64}\*16\*[a-f0-9]{32}\*16\*[a-f0-9]{32}\*0\*[a-f0-9]{2048}$"##), modes: vec![
          HashInfo{ name: "Open Document Format (ODF) 1.2 (SHA-256, AES)", john: None ,hashcat: Some("18400") ,variation: false ,description: None },
]},
     Pattern { regex: regex!(r##"(?i)^[A-Za-z0-9-_]*\.[A-Za-z0-9-_]*\.[A-Za-z0-9-_]*$"##), modes: vec![
